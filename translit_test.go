...
پيازدىڭ قۇرامىنداعى پروستاگلاندين a نىڭ تامىردى كەڭەيتۋ رولى بار بولىپ، دەنەنىڭ قابىنۋعا بولعان سەزىمتالدىعىن باسەڭدەتۋ، قان قىسىمىن مەڭگەرۋ جانە قاننىڭ جابىسقاقتىعىن تومەندەتۋدە كورنەكتى ونىمدىلىگى بار.
	...
	fmt.Print(ArabicToCyrillic(a))

}
func TestCtoA(t *testing.T) {

	a := `Абай (Ибраһим) Құнанбаев (1845-1904) — ақын, ағартушы, жазба қазақ әдебиетінің, қазақ әдеби тілінің негізін қалаушы, философ, композитор, аудармашы, саяси қайраткер[1], либералды көзқарасын исламға таяна отырып, орыс және еуропа мәдениетімен жақындасу арқылы қазақ мәдениетін жаңартуды көздеген реформатор. Абай ақындық шығармаларында қазақ халқының әлеуметтік, қоғамдық, моральдық мәселелерін арқау еткен.[2]
...
Абай ұлдары Ақылбай (сол жақта) және Тұрағұлмен (оң жақта) бірге
...
Толық мақаласы: Абай Құнанбайұлының дінге көзқарасы
...
Дереккөздер
 ...
 Қазақстан тарихы (XVIII ғасыр — 1914 жыл). Жалпы білім беретін мектептің 8-сыныбына арналған оқулық. Қабылдинов З.Е., Қайыпбаева А.Т.Алматы: Атамұра, 2008. — 352 бет, суретті, карталы. ISBN 9965-34-816-2`
	...
	fmt.Println(CyrillicToArabic(a))
